...
1. **Learn [TypeScript](../../languages/typescript/fundamentals/)** first - Angular is TypeScript-first
2. **Master [Fundamentals](./fundamentals/)** - Components, services, RxJS
3. **Practice [Testing](./angular-testing)** - Jasmine, Karma, TestBed
4. **Explore ecosystem** - Angular Material, NgRx, Universal
5. **Build projects** - Apply concepts in real applications

## Related Topics

- [TypeScript Fundamentals](../../languages/typescript/fundamentals/) - Required for Angular
