...
**Topics covered:**
- [Character Encoding](./character-encoding) - UTF-8, Unicode, and proper encoding
- [HTML Basics](./html-basics) - Semantic markup and accessibility
...
1. **Start with Fundamentals** if you're new to web development
