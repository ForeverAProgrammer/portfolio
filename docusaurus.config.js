...
const config = {
  ...
  themeConfig:
    ...
    ({
      // Custom social card for portfolio
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/ForeverAProgrammer',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Email',
                href: 'mailto:kristinathecoder@gmail.com',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} kristina.codes`,
      },
      prism: {
